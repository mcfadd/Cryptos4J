...
public class Util {
	...
	/**
	 * gets the api key parameter (if any) to be used - see 
	 * <a href="https://www.cryptocompare.com/coins/guides/how-to-use-our-api/">cryptocompare.com/coins/guides/how-to-use-our-api/</a> for more info.
	 * @return apiKey
	 * @since Cryptos4J v1.0
	 */
	...
	/**
	 * sets the api key parameter to be used - see 
	 * <a href="https://www.cryptocompare.com/coins/guides/how-to-use-our-api/">cryptocompare.com/coins/guides/how-to-use-our-api/</a> for more info.
    ...
    public static String calendarToString(Calendar calendar) {
    	return String.format("%04d-%02d-%02d %02d:%02d:%02d", calendar.get(Calendar.YEAR), calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH), calendar.get(Calendar.HOUR), calendar.get(Calendar.MINUTE), calendar.get(Calendar.SECOND));
    }
